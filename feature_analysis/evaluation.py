...
def evaluate(test, model, bounds):
    ...
    acc_orig = accuracy_score(y_test0, preds0.round())
    ...
    if len(testu) > 0:
        ...
        auc_u = (roc_auc_score(y_testu, predsu))
    ...
    try:
        ...
        acc_new = accuracy_score(y_testb, predsb.round())
    ...
    print ("Accuracy:", acc_orig*100, acc_new*100, acc_u*100)
    print (len(testb), len(testu))